        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="{{ $user->image ? asset('storage/' . $user->image) : asset('/images/profil.png') }}" alt="Profile" class="rounded-circle">
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">{{ $user->about ?? 'No description available.' }}</p>
                  ...
                  <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="{{ $user->image ? asset('storage/' . $user->image) : asset('images/profil.png') }}" alt="Profile">
                        <div class="pt-2">
