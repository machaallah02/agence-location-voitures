...
<div id="main" class="main">
    ...
    <form action="{{ route('admin.reservations.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" name="coût_total" id="coût_total" class="form-control" step="0.01" value="{{ old('coût_total') }}" required>
        ...
        <div class="form-group">
            ...
            <select name="statut" id="statut" class="form-control" required>
                ...
                <option value="complété" {{ old('statut') == 'complété' ? 'selected' : '' }}>Complété</option>
            </select>
