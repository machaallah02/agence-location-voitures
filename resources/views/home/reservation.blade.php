        ...
        <div class="reservation-card">
            ...
            <div class="reservation-card__info">
                ...
                <div class="reservation-form">
                    ...
                    <form id="reservationForm" method="POST" action="{{ route('reservations.store') }}" class="bg-white p-4 rounded shadow">
                        @csrf
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="date" id="date_debut" name="date_debut" class="form-control form-control-lg" required>
                        </div>

                        <div class="form-group mb-4">
                            <label for="date_fin" class="form-label">Date de fin</label>
                            <input type="date" id="date_fin" name="date_fin" class="form-control form-control-lg" required>
                        </div>

                        <div id="costSection" class="d-none text-center mt-4">
                            <h3 class="mb-4"><strong>Coût Total :</strong> <span id="totalCost" class="text-warning"></span> franc CFA</h3>
